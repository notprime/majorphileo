...
from model.model_Mixer import Mixer, CNNBlock
from model.model_CoreCNN import CoreEncoder, CoreCNNBlock, CoreUnet, CoreUnet_combined
from model.model_Mixer_versions import Mixer_tiny
...
if __name__ == '__main__':
    ...
    sd_1 = torch.load('/home/lcamilleri/git_repos/phileo-testbed/model/test.pt')
